...
const String pageId = 'left_small_1_continuous_page';
// List of buttons
...
//
class LeftSmall1ContinuousPage extends ConsumerStatefulWidget {
  const LeftSmall1ContinuousPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _LeftSmall1ContinuousPageState();
}

class _LeftSmall1ContinuousPageState
    extends ConsumerState<LeftSmall1ContinuousPage> {
