...
const String pageId = 'right_small_1.5_continuous_page';
// List of buttons
...
//
class RightSmall15ContinuousPage extends ConsumerStatefulWidget {
  const RightSmall15ContinuousPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _RightSmall15ContinuousPageState();
}

class _RightSmall15ContinuousPageState
    extends ConsumerState<RightSmall15ContinuousPage> {
