...
const String pageId = 'left_continuous_small_1_page';
...
//
class LeftContinuousSmall1Page extends ConsumerStatefulWidget {
  const LeftContinuousSmall1Page({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _LeftContinuousSmall1PageState();
}

class _LeftContinuousSmall1PageState
    extends ConsumerState<LeftContinuousSmall1Page> {
