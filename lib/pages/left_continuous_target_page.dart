...
//
class LeftContinuousTargetPage extends ConsumerStatefulWidget {
  final double targetSize;
  final double cdGain;

  const LeftContinuousTargetPage(this.targetSize, this.cdGain, {super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _LeftContinuousTargetPageState();
}

class _LeftContinuousTargetPageState
    extends ConsumerState<LeftContinuousTargetPage> {
  String pageId = 'left_continuous_target_page';
  double targetSize = 0;
  double cdGain = 0;
  ...
  void initState() {
    ...
    if (targetSize == 42) {
      ...
      generateRandomPositions(
          30, width - 30, 10, height / 2, 15, 0, targetSize);
      generateRandomPositions(
          width / 2, width - 50, height / 2, height - 100, 5, 15, targetSize);
      ...
      generateRandomPositions(
          width / 2, width - 70, height / 2, height - 100, 5, 15, targetSize);
    }
  }
