...
const String pageId = 'right_big_1_continuous_page';
// List of buttons
...
//
class RightBig1ContinuousPage extends ConsumerStatefulWidget {
  const RightBig1ContinuousPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _RightBig1ContinuousPageState();
}

class _RightBig1ContinuousPageState
    extends ConsumerState<RightBig1ContinuousPage> {
