...
const String pageId = 'right_continuous_small_1_page';
...
//
class RightContinuousSmall1Page extends ConsumerStatefulWidget {
  const RightContinuousSmall1Page({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _RightContinuousSmall1PageState();
}

class _RightContinuousSmall1PageState
    extends ConsumerState<RightContinuousSmall1Page> {
